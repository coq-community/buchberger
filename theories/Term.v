...
Definition eqTerm_dec : forall x y : Term, {eqTerm x y} + {~ eqTerm x y}.
...
Definition zeroP_dec : forall x : Term, {zeroP x} + {~ zeroP x}.
...
Proof using multA minusA invA divA cs A1.
intros a b; case a; case b; simpl in |- *; auto.
...
Proof using minusA invA divA cs A1 A0.
intros a b c; case a; case b; case c; simpl in |- *; auto.
...
Proof using plusA multA minusA divA cs A1.
intros a; case a; simpl in |- *; auto.
intros b H' H'0;
...
Proof using plusA multA minusA divA cs A1 A0.
intros a; case a; simpl in |- *; auto.
...
Proof using plusA multA minusA invA divA cs.
simpl in |- *; auto.
...
Proof using multA divA cs A1 A0.
intros a b; case a; case b; simpl in |- *; auto.
split; auto.
...
Proof using plusA minusA invA eqA_dec divA cs A1.
intros a b; case a; case b; simpl in |- *; auto.
intros a0 m a1 m0 H.
...
Proof using plusA invA divA cs A1 A0.
intros a b c eqT1.
...
Local Hint Resolve multTerm_minusTerm_dist_l : core.
